...
const register = async (req, res) => {
  ...
  /* CREAR UNA VALIDACION DONDE SE VERIFIQUE QUE EL DEPARTAMENTO Y EL MUNICIPIO QUE ESTA INGRESANDO EL USUARIO EXISTAN EN LA COLECCION DE DEPARTAMENTOMUNICIPIO SI EXISTE LE PERMITE REGISTRARSE SI NO LE MUESTRA UN MENSAJE 
  INDICANDO QUE ESE DEPARTAMENTO O MUNICIPIO NO ES VALIDO */
